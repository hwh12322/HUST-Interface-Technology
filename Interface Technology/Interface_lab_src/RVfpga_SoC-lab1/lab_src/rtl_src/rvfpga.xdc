...
#全向传声器
set_property -dict { PACKAGE_PIN J5  IOSTANDARD LVCMOS33 }[get_ports { pdm_m_data_i }];
set_property -dict { PACKAGE_PIN H5  IOSTANDARD LVCMOS33 }[get_ports { pdm_m_clk_o }];
...
set_property -dict { PACKAGE_PIN D12  IOSTANDARD LVCMOS33 }[get_ports { pwm_sd_o }];