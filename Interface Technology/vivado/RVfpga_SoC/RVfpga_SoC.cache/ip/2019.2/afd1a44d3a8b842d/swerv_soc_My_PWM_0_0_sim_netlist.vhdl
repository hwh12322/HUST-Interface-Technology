...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_My_Controller is
  ...
  signal \hold[4]_i_1_n_0\ : STD_LOGIC;
  signal \hold[5]_i_1_n_0\ : STD_LOGIC;
  signal \hold[8]_i_2_n_0\ : STD_LOGIC;
  signal hold_reg : STD_LOGIC_VECTOR ( 8 downto 1 );
  signal \p_0_in__0\ : STD_LOGIC_VECTOR ( 8 downto 1 );
  signal NLW_AUD_PWM0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_AUD_PWM0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \hold[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \hold[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \hold[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \hold[5]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \hold[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \hold[8]_i_1\ : label is "soft_lutpair5";
begin
...
\AUD_PWM0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_AUD_PWM0_carry__0_CO_UNCONNECTED\(3 downto 1),
...
\AUD_PWM0_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
AUD_PWM0_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\hold[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\hold[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\hold[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\hold[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"807F"
    )
        port map (
...
\hold[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EAAA1555"
    )
        port map (
...
\hold[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\hold[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\hold[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\hold[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\hold_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(1),
...
\hold_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(2),
...
\hold_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(3),
...
\hold_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \hold[4]_i_1_n_0\,
...
\hold_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \hold[5]_i_1_n_0\,
...
\hold_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(6),
...
\hold_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(7),
...
\hold_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \p_0_in__0\(8),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_My_PWM_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg0[0]_i_3\ : label is "soft_lutpair8";
begin
  AUD_SD <= \^aud_sd\;
