...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_My_Controller is
  signal AUD_PWM_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of AUD_PWM_i_1 : label is "soft_lutpair4";
...
begin
AUD_PWM_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_My_PWM_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg0[0]_i_3\ : label is "soft_lutpair6";
begin
  AUD_SD <= \^aud_sd\;
