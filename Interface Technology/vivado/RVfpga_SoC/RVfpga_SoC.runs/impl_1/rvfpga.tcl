...
set rc [catch {
  ...
  add_files -quiet D:/destop/vivado/RVfpga_SoC/RVfpga_SoC.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source D:/destop/vivado/RVfpga_SoC/script.tcl"
    source D:/destop/vivado/RVfpga_SoC/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/destop/vivado/RVfpga_SoC/script.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
