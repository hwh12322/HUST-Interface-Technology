...
HD_PWD='D:/destop/vivado/RVfpga_SoC/RVfpga_SoC.runs/swerv_soc_My_PWM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_soc_My_PWM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_soc_My_PWM_0_0.tcl
