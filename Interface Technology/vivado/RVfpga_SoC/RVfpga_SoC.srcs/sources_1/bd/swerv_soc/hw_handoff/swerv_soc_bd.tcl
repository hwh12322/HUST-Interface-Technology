...
proc create_root_design { parentCell } {
  ...
  set Digits_Bits [ create_bd_port -dir O -from 6 -to 0 Digits_Bits ]
  ...
  set pwm_pad_o_0 [ create_bd_port -dir O pwm_pad_o_0 ]
  set rst_0 [ create_bd_port -dir I -type rst rst_0 ]

  # Create instance: My_PWM_0, and set properties
  set My_PWM_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:My_PWM:2.0 My_PWM_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins My_PWM_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  ...
  connect_bd_net -net My_PWM_0_AUD_PWM [get_bd_ports AUD_PWM] [get_bd_pins My_PWM_0/AUD_PWM]
  connect_bd_net -net My_PWM_0_AUD_SD [get_bd_ports AUD_SD] [get_bd_pins My_PWM_0/AUD_SD]
  ...
  connect_bd_net -net ptc_wrapper_0_pwm_pad_o [get_bd_ports pwm_pad_o_0] [get_bd_pins ptc_wrapper_0/pwm_pad_o]
  ...
  connect_bd_net -net syscon_wrapper_0_AN [get_bd_ports AN] [get_bd_pins syscon_wrapper_0/AN]
  connect_bd_net -net syscon_wrapper_0_Digits_Bits [get_bd_ports Digits_Bits] [get_bd_pins syscon_wrapper_0/Digits_Bits]
  ...
  assign_bd_address -offset 0x80140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs My_PWM_0/S00_AXI/S00_AXI_reg] -force
