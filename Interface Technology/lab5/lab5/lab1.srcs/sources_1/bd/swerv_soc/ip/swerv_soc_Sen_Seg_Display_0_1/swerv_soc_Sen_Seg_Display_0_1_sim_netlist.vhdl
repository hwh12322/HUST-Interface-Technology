...
-- Date        : Mon Oct 30 20:44:20 2023
-- Host        : VOIPC67 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top swerv_soc_Sen_Seg_Display_0_1 -prefix
--               swerv_soc_Sen_Seg_Display_0_1_ swerv_soc_Sen_Seg_Display_0_0_sim_netlist.vhdl
...
entity swerv_soc_Sen_Seg_Display_0_1_SenSegController is
  port (
...
end swerv_soc_Sen_Seg_Display_0_1_SenSegController;

architecture STRUCTURE of swerv_soc_Sen_Seg_Display_0_1_SenSegController is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0_S00_AXI is
  port (
...
end swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0_S00_AXI;

architecture STRUCTURE of swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0_S00_AXI is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0 is
  port (
...
end swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0;

architecture STRUCTURE of swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0 is
  signal Sen_Seg_Display_v3_0_S00_AXI_inst_n_1 : STD_LOGIC;
  signal cur_num : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal sel0 : STD_LOGIC_VECTOR ( 2 downto 0 );
begin
SenSegController_inst: entity work.swerv_soc_Sen_Seg_Display_0_1_SenSegController
     port map (
...
Sen_Seg_Display_v3_0_S00_AXI_inst: entity work.swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0_S00_AXI
     port map (
      D(3 downto 0) => cur_num(3 downto 0),
      Disp_Num(31 downto 0) => Disp_Num(31 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_Sen_Seg_Display_0_1 is
  port (
    AN : out STD_LOGIC_VECTOR ( 7 downto 0 );
    Digits_Bits : out STD_LOGIC_VECTOR ( 6 downto 0 );
    Disp_Num : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of swerv_soc_Sen_Seg_Display_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of swerv_soc_Sen_Seg_Display_0_1 : entity is "swerv_soc_Sen_Seg_Display_0_0,Sen_Seg_Display_v3_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of swerv_soc_Sen_Seg_Display_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of swerv_soc_Sen_Seg_Display_0_1 : entity is "Sen_Seg_Display_v3_0,Vivado 2019.2";
end swerv_soc_Sen_Seg_Display_0_1;

architecture STRUCTURE of swerv_soc_Sen_Seg_Display_0_1 is
...
inst: entity work.swerv_soc_Sen_Seg_Display_0_1_Sen_Seg_Display_v3_0
     port map (
      AN(7 downto 0) => AN(7 downto 0),
      Digits_Bits(6 downto 0) => Digits_Bits(6 downto 0),
      Disp_Num(31 downto 0) => Disp_Num(31 downto 0),
