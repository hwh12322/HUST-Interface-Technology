...
HD_PWD='D:/destop/Interface_lab/lab5/lab1.runs/swerv_soc_Sen_Seg_Display_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_soc_Sen_Seg_Display_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_soc_Sen_Seg_Display_0_2.tcl
