...
set rc [catch {
  ...
  add_files -quiet D:/destop/Interface_lab/lab5/lab1.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source D:/destop/Interface_lab_src/RVfpga_SoC-lab1/lab_src/script.tcl"
    source D:/destop/Interface_lab_src/RVfpga_SoC-lab1/lab_src/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/destop/Interface_lab_src/RVfpga_SoC-lab1/lab_src/script.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
